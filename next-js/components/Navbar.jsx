    ...
    <>
      <nav className='flex items-center flex-wrap bg-gray-900 p-3 '>
        <Link href='/'>
          ...
          <Image src={Logo} height={60} width={60} className='rounded-2xl' />
            {/* <img src={Logo}
              className='fill-current h-8 w-8 mr-2'
            >
            </img> */}
            {/* <img src="/assets/images/unsplash-1.jpeg" style={{width: "100%", height: "auto"}}/> */}
            <span className='ml-5 text-xl text-white tracking-wide'>
              Find My Pet
            </span>
          </a>
        </Link>
        ...
        >
          <div className='lg:inline-flex lg:flex-row lg:ml-auto lg:w-auto w-full lg:items-center items-start  flex flex-col lg:h-auto'>
            <Link href='/'>
              <a className='lg:inline-flex lg:w-auto w-full px-3 py-2 rounded text-white items-center justify-center hover:text-blue-300'>
                Home
              </a>
            </Link>
            <Link href='/'>
